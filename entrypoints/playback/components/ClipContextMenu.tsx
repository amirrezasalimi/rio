...
export function ClipContextMenu({ label, onOpen, onDuplicate, onDelete, onDownload, onSplitAudio }: { label: string; onOpen: () => void; onDuplicate: () => void; onDelete: () => void; onDownload?: () => void; onSplitAudio?: () => void }) {
