...
export function TextSettingsPanel() {
  ...
  return <>
    <InspectorSection icon={Type} title="Content" summary={clip.text || 'Empty text'} searchTerms="copy words edit textarea" defaultOpen>
    ...
    <InspectorSection icon={CaseSensitive} title="Typography" summary={`${clip.fontFamily} · ${clip.fontSize}px · ${clip.fontWeight}`} searchTerms="font family size weight regular bold installed" defaultOpen>
    ...
    <InspectorSection icon={RotateCw} title="Transform" summary={`${clip.scale}% scale · ${clip.rotation}°`} searchTerms="size scale rotation angle rotate">
    ...
    <InspectorSection icon={Brush} title="Fill" summary={`${clip.fill.type} · ${clip.opacity}% opacity`} searchTerms="color solid gradient angle opacity transparency">
    ...
    <InspectorSection icon={Square} title="Stroke" summary={`${clip.strokeWidth}px`} searchTerms="outline weight width color">
    ...
    <InspectorSection icon={Square} title="Background" summary={`${clip.backgroundOpacity}% opacity · ${clip.backgroundRadius ?? 8}px radius`} searchTerms="color opacity transparency radius corner">
