  ...
  return (
    <main className="min-h-screen bg-canvas text-ink">
      <header className="sticky top-0 z-30 border-b border-border bg-surface/92 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8"><LogoMark /><button type="button" onClick={() => void openRecorder()} className="flex items-center gap-2 rounded-xl bg-primary-500 px-4 py-2.5 text-xs font-semibold text-white shadow-md shadow-primary-500/20 transition hover:bg-primary-600"><Plus className="size-4" />New recording</button></div>
      </header>
